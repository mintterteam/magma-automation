...
func main() {
	...
	minFee := flag.Int("minfee", 2, "minimum mining fee (in sats per vByte) to pay for opening channels")
	maxFee := flag.Int("maxfee", 10, "maximum mining fee (in sats per vByte) to pay for opening channels")
